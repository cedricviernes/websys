...
<style>
  ...
  body {
    ...
    background-color: #fef8f6; /* Light pastel background */
  ...
  /* Specific button colors for Miniso vibe */
  .btn-login {
  ...
  /* Optional: Add a cute SVG or image here */
  .illustration svg {
    width: 300px;
    height: auto;
  }
...
<header>
  <?php if(Route::has('login')): ?>
    <?php if(auth()->guard()->check()): ?>
      <a href="<?php echo e(url('/dashboard')); ?>" class="btn" style="background-color:#4fc3f7; color:#fff; border-radius:50px;">Dashboard</a>
    <?php else: ?>
...
<!-- Footer -->
<footer>
  &copy; <?php echo e(date('Y')); ?> Miniso Inspired. All rights reserved.
</footer>

</body>
</html><?php /**PATH C:\xampp\htdocs\ELEC1\resources\views/welcome.blade.php ENDPATH**/ ?>