...
<div class="container" style="max-width: 600px; margin: 2rem auto; background: #fff; border-radius: 8px; box-shadow: 0 2px 8px rgba(0,0,0,0.06); padding: 2rem;">
    <h1 style="margin-bottom: 1.5rem;">Add New User</h1>
    ...
    <form action="{{ route('admin.users.store') }}" method="POST">
        ...
        <div class="mb-3" style="margin-bottom: 1rem;">
            ...
            <input type="email" name="email" id="email" class="form-control" style="width: 100%; padding: 0.5rem; border-radius: 4px; border: 1px solid #e5e7eb;" value="{{ old('email') }}" required>
        </div>

        <div class="mb-3" style="margin-bottom: 1rem;">
            <label for="password" class="form-label" style="font-weight: 500;">Password</label>
            <input type="password" name="password" id="password" class="form-control" style="width: 100%; padding: 0.5rem; border-radius: 4px; border: 1px solid #e5e7eb;" required>
        </div>

        <div class="mb-3" style="margin-bottom: 1rem;">
            <label for="password_confirmation" class="form-label" style="font-weight: 500;">Confirm Password</label>
            <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" style="width: 100%; padding: 0.5rem; border-radius: 4px; border: 1px solid #e5e7eb;" required>
        </div>
